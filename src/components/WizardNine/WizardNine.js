        ...
        return(
            <div className="parent-div">
                <div className="vert-align">                    
                    ...
                    <input type="text" placeholder="Line One" onChange={(e) => this.props.updateAddress(e.target.value)}/>
                    <input type="text" placeholder="Line Two" onChange={(e) => this.props.updateAddress(e.target.value)}/>
                    <input type="text" placeholder="Line Three" onChange={(e) => this.props.updateAddress(e.target.value)}/>
